...
import { FaBookOpen, FaUserGraduate, FaAward, FaChartLine } from "react-icons/fa";
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6">
            ...
            <p className="hero-text">
              ...
              Application's innovative Learning Management System.
              Access courses, assignments, and resources anytime,
              anywhere.
            </p>

            <div className="hero-buttons">

              <Link className="btn hero-login" to="/login">
                Login to LMS →
              </Link>

              <Link className="btn hero-course" to="/courses">
                Explore Courses
              </Link>
        ...
        <div className="row mt-5">
          ...
          <div className="col-md-3">
            <div className="why-card">
              ...
              <p>
                BCA, BBA, and specialized courses
              </p>
